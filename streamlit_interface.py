...
if st.button("Ask"):
    if user_input:
        try:
            response = requests.post("http://127.0.0.1:8000/ask", json={"prompt": user_input})
...
st.markdown("Peachy is here to assist you with your questions. Feel free to ask anything!")
